...
public class CanvasRecorder {
    ...
    public void saveCanvasToFile( GLAutoDrawable drawable ) {
    	...
    	if ( image == null || image.getWidth() != width || image.getHeight() != height ) {
            ...
            imageBuf = ByteBuffer.wrap(((DataBufferByte)image.getRaster().getDataBuffer()).getData());
    	}
        ...
        gl.glReadPixels( 0, 0, width, height, GL2.GL_BGR, GL.GL_UNSIGNED_BYTE, imageBuf );
